...
use crate::{message::Message, sequence::Sequence, time::timestamp::Timestamp};
...
impl Scheduler {
    ...
    pub(crate) fn push(&mut self, ts: Timestamp, seq: Sequence, msg: impl Message) {
    ...
    pub(crate) fn push_boxed(&mut self, ts: Timestamp, seq: Sequence, payload: Box<dyn Message>) {
