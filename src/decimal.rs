...
pub enum DecimalError {
    ...
    #[error("scale exceeds maximum ({})", SignedDecimal::MAX_SCALE)]
    ScaleOverflow,
...
impl SignedDecimal {
    ...
    pub fn sub(self, other: Self) -> Result<Self, DecimalError> {
        ...
        let negated = match other.sign {
            Sign::Positive => SignedDecimal {
                inner: other.inner,
                scale: other.scale,
                sign: Sign::Negative,
            },
            Sign::Negative => SignedDecimal {
                inner: other.inner,
                scale: other.scale,
                sign: Sign::Positive,
            },
...
#[cfg(test)]
mod signed_decimal_tests {
    use super::*;
    use std::hash::Hasher;

    fn assert_positive(d: SignedDecimal, inner: u128, scale: u8, str: &str) {
    ...
    fn assert_negative(d: SignedDecimal, inner: u128, scale: u8, str: &str) {
        assert_eq!(d.as_raw(), inner);
        assert_eq!(d.scale(), scale);
    ...
    fn assert_zero(d: SignedDecimal) {
        assert_eq!(d, SignedDecimal::ZERO);
        assert_eq!(d.to_string(), "0");
    }

    fn hash_of(d: &SignedDecimal) -> u64 {
    ...
    fn from_raw_positive() {
        let d = SignedDecimal::from_raw(12345, 2, Sign::Positive).unwrap();
    ...
    fn from_raw_negative() {
        let d = SignedDecimal::from_raw(42, 1, Sign::Negative).unwrap();
    ...
    fn from_raw_zero_inner_normalizes_to_zero() {
        let d = SignedDecimal::from_raw(0, 5, Sign::Positive).unwrap();
        assert_zero(d);
    }
    ...
    fn from_non_zero_inner_zero_sign() {
        let d = SignedDecimal::from_raw(1, 5, Sign::Zero);
    ...
    #[test]
    fn scale_too_big() {
        let d = SignedDecimal::from_raw(1, SignedDecimal::MAX_SCALE + 1, Sign::Positive);
        assert_eq!(d, Err(DecimalError::ScaleOverflow));

        let d = SignedDecimal::from_raw(1, SignedDecimal::MAX_SCALE, Sign::Positive).unwrap();
        assert_positive(
            d,
            1,
            SignedDecimal::MAX_SCALE,
            &format!("0.{}1", "0".repeat(SignedDecimal::MAX_SCALE as usize - 1)),
        );
    }
    ...
    fn from_str_positive_integer() {
        let d = SignedDecimal::from_str("123").unwrap();
    ...
    fn from_str_negative_integer() {
        let d = SignedDecimal::from_str("-456").unwrap();
    ...
    fn from_str_positive_decimal() {
        let d = SignedDecimal::from_str("123.45").unwrap();
        assert_positive(d, 12345, 2, "123.45");
    }
    ...
    fn from_str_negative_decimal() {
        let d = SignedDecimal::from_str("-4.2").unwrap();
        assert_negative(d, 42, 1, "-4.2");
    }
    ...
    #[test]
    fn from_str_zero() {
        let d = SignedDecimal::from_str("0").unwrap();
        assert_zero(d);
    }
    ...
    fn from_str_negative_zero_rejected() {
        let err = SignedDecimal::from_str("-0");
    ...
    fn from_str_negative_zero_decimal_rejected() {
        let err = SignedDecimal::from_str("-0.0");
        assert_eq!(err, Err(DecimalError::InvalidFormat));
    }
    ...
    fn from_str_leading_zeros_rejected() {
        let err = SignedDecimal::from_str("007");
        assert_eq!(err, Err(DecimalError::InvalidFormat));
    }
    ...
    fn from_str_double_zero_rejected() {
        let err = SignedDecimal::from_str("00");
        assert_eq!(err, Err(DecimalError::InvalidFormat));
    }
    ...
    fn from_str_trailing_dot_rejected() {
        let err = SignedDecimal::from_str("1.");
        assert_eq!(err, Err(DecimalError::InvalidFormat));
    }
    ...
    fn from_str_whitespace_rejected() {
        let err = SignedDecimal::from_str("  42.5  ");
        assert_eq!(err, Err(DecimalError::InvalidFormat));
    }
    ...
    fn from_str_leading_dot() {
        let d = SignedDecimal::from_str(".5").unwrap();
    ...
    fn from_str_leading_zero_dot() {
        let d = SignedDecimal::from_str("0.5").unwrap();
        assert_positive(d, 5, 1, "0.5");
    }
    ...
    fn from_str_trailing_fractional_zeros() {
        let d = SignedDecimal::from_str("1.00").unwrap();
    ...
    #[test]
    fn from_str_empty() {
        let err = SignedDecimal::from_str("");
        assert_eq!(err, Err(DecimalError::InvalidFormat));
    }
    ...
    fn from_str_double_dot() {
        let err = SignedDecimal::from_str("1.2.3");
        assert_eq!(err, Err(DecimalError::InvalidFormat));
    }
    ...
    #[test]
    fn from_str_letters() {
        let err = SignedDecimal::from_str("abc");
        assert_eq!(err, Err(DecimalError::InvalidFormat));
    }
    ...
    fn from_str_overflow() {
        let err = SignedDecimal::from_str("340282366920938463463374607431768211456");
    ...
    fn from_str_scale_overflow() {
        let zeros = "0".repeat(SignedDecimal::MAX_SCALE as usize + 1);
        let input = format!("0.{}1", zeros);
        let err = SignedDecimal::from_str(&input);
    ...
    fn normalized_parts_zero() {
        assert_eq!(SignedDecimal::ZERO.normalized_parts(), (0, 0));
    }

    /// Invariant: normalizing (100, 2) strips trailing zeros to (1, 0).
    #[test]
    fn normalized_trailing_fractional_zeros() {
        let d = SignedDecimal::from_raw(100, 2, Sign::Positive).unwrap();
        let n = d.normalized();
    ...
    fn normalized_integer_no_effect() {
        let d = SignedDecimal::from_raw(500, 0, Sign::Positive).unwrap();
        let n = d.normalized();
    ...
    #[test]
    fn normalized_zero() {
        assert_zero(SignedDecimal::ZERO.normalized());
    }

    /// Invariant: normalizing negative value strips trailing zeros but preserves sign.
    #[test]
    fn normalized_negative() {
        let d = SignedDecimal::from_raw(1200, 2, Sign::Negative).unwrap(); // -12.00
        let n = d.normalized();
    ...
    fn normalized_idempotent() {
        let d = SignedDecimal::from_raw(15, 1, Sign::Positive).unwrap(); // 1.5
        let n = d.normalized();
    ...
    fn partial_eq_same_value_same_repr() {
        let a = SignedDecimal::from_raw(10, 1, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(10, 1, Sign::Positive).unwrap();
        assert_eq!(a, b);
    ...
    fn partial_eq_same_value_trailing_zeros() {
        let a = SignedDecimal::from_raw(100, 2, Sign::Positive).unwrap(); // 1.00
        let b = SignedDecimal::from_raw(10, 1, Sign::Positive).unwrap(); // 1.0
        assert_eq!(a, b);
    ...
    fn partial_eq_integer_equals_decimal() {
        let a = SignedDecimal::from_raw(1, 0, Sign::Positive).unwrap(); // 1
        let b = SignedDecimal::from_raw(10, 1, Sign::Positive).unwrap(); // 1.0
        let c = SignedDecimal::from_raw(100, 2, Sign::Positive).unwrap(); // 1.00
        assert_eq!(a, b);
        assert_eq!(b, c);
        assert_eq!(a, c);
    ...
    fn partial_eq_different_signs_not_equal() {
        let pos = SignedDecimal::from_raw(10, 1, Sign::Positive).unwrap(); // 1.0
        let neg = SignedDecimal::from_raw(10, 1, Sign::Negative).unwrap(); // -1.0
        assert_ne!(pos, neg);
    ...
    fn partial_eq_different_values_not_equal() {
        let a = SignedDecimal::from_raw(10, 1, Sign::Positive).unwrap(); // 1.0
        let b = SignedDecimal::from_raw(20, 1, Sign::Positive).unwrap(); // 2.0
        assert_ne!(a, b);
        assert_positive(a, 10, 1, "1.0");
    ...
    fn partial_eq_different_values_different_scale_not_equal() {
        let a = SignedDecimal::from_raw(15, 1, Sign::Positive).unwrap(); // 1.5
        let b = SignedDecimal::from_raw(105, 2, Sign::Positive).unwrap(); // 1.05
        assert_ne!(a, b);
    ...
    fn partial_eq_all_zeros_equal() {
        let a = SignedDecimal::ZERO;
        let b = SignedDecimal::from_raw(0, 5, Sign::Positive).unwrap();
        let c = SignedDecimal::from_str("0").unwrap();
        assert_eq!(a, b);
        assert_eq!(b, c);
        assert_eq!(a, c);
        assert_zero(a);
    ...
    fn partial_eq_negative_trailing_zeros() {
        let a = SignedDecimal::from_raw(100, 2, Sign::Negative).unwrap(); // -1.00
        let b = SignedDecimal::from_raw(10, 1, Sign::Negative).unwrap(); // -1.0
        assert_eq!(a, b);
    ...
    fn partial_eq_zero_not_equal_to_nonzero() {
        ...
        let one = SignedDecimal::from_raw(1, 0, Sign::Positive).unwrap();
        let neg_one = SignedDecimal::from_raw(1, 0, Sign::Negative).unwrap();
        assert_ne!(zero, one);
    ...
    fn hash_equal_values_same_hash() {
        let a = SignedDecimal::from_raw(100, 2, Sign::Positive).unwrap(); // 1.00
        let b = SignedDecimal::from_raw(10, 1, Sign::Positive).unwrap(); // 1.0
        let c = SignedDecimal::from_raw(1, 0, Sign::Positive).unwrap(); // 1
        assert_eq!(hash_of(&a), hash_of(&b));
    ...
    fn hash_negative_trailing_zeros() {
        let a = SignedDecimal::from_raw(100, 2, Sign::Negative).unwrap(); // -1.00
        let b = SignedDecimal::from_raw(10, 1, Sign::Negative).unwrap(); // -1.0
        let c = SignedDecimal::from_raw(1, 0, Sign::Negative).unwrap(); // -1
        assert_eq!(hash_of(&a), hash_of(&b));
        assert_eq!(hash_of(&b), hash_of(&c));
        assert_eq!(a, b);
        assert_eq!(b, c);
    ...
    fn hash_collision_smoke_test() {
        ...
        let a = SignedDecimal::from_str("123.45").unwrap();
        let b = SignedDecimal::from_str("-123.45").unwrap();
        let c = SignedDecimal::from_str("0").unwrap();
        let d = SignedDecimal::from_str("1").unwrap();
    ...
    fn ord_zero_equals_zero() {
        let a = SignedDecimal::ZERO;
        let b = SignedDecimal::from_str("0").unwrap();
    ...
    fn ord_zero_less_than_positive() {
        let zero = SignedDecimal::ZERO;
        let pos = SignedDecimal::from_str("1.0").unwrap();
        assert!(zero < pos);
        assert!(pos > zero);
        assert_zero(zero);
        assert_positive(pos, 10, 1, "1.0");
    ...
    fn ord_negative_less_than_zero() {
        let neg = SignedDecimal::from_str("-1.0").unwrap();
        let zero = SignedDecimal::ZERO;
        assert!(neg < zero);
        assert!(zero > neg);
        assert_negative(neg, 10, 1, "-1.0");
    ...
    fn ord_same_scale_positives() {
        let a = SignedDecimal::from_str("1.0").unwrap();
        let b = SignedDecimal::from_str("2.0").unwrap();
        assert!(a < b);
        assert!(b > a);
        assert_positive(a, 10, 1, "1.0");
        assert_positive(b, 20, 1, "2.0");
    ...
    fn ord_same_scale_negatives() {
        let a = SignedDecimal::from_str("-2.0").unwrap();
        let b = SignedDecimal::from_str("-1.0").unwrap();
        assert!(a < b);
        assert!(b > a);
    ...
    fn ord_trailing_zeros_equal() {
        let a = SignedDecimal::from_str("1.00").unwrap();
        let b = SignedDecimal::from_str("1.0").unwrap();
        let c = SignedDecimal::from_str("1").unwrap();
        assert_eq!(a.cmp(&b), std::cmp::Ordering::Equal);
    ...
    fn ord_different_scale_positives() {
        ...
        let a = SignedDecimal::from_str("1.1").unwrap();
        let b = SignedDecimal::from_str("1.09").unwrap();
        assert!(a > b);
        assert!(b < a);
    ...
    fn ord_integer_vs_fraction() {
        ...
        let b = SignedDecimal::from_str("1.999").unwrap();
        assert!(a > b);
    ...
    fn ord_partial_cmp_always_returns_some() {
        let a = SignedDecimal::from_str("-3.14").unwrap();
        let b = SignedDecimal::from_str("2.718").unwrap();
    ...
    fn ord_sort_integrity() {
        let mut vals = vec![
            ...
            SignedDecimal::from_str("2.5").unwrap(),
            SignedDecimal::from_str("-1.0").unwrap(),
            SignedDecimal::from_str("0.1").unwrap(),
            SignedDecimal::from_str("-2.5").unwrap(),
            SignedDecimal::from_str("1.00").unwrap(),
        ];
        vals.sort();
        assert_eq!(
    ...
    fn ord_overflow_a_not_b() {
        let a = SignedDecimal::from_raw(u128::MAX, 0, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(1, 38, Sign::Positive).unwrap();
        assert!(a > b);
        assert!(b < a);
    }
    ...
    fn ord_overflow_b_not_a() {
        let a = SignedDecimal::from_raw(1, 38, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(u128::MAX, 0, Sign::Positive).unwrap();
        assert!(a < b);
        assert!(b > a);
    }
    ...
    fn ord_overflow_negative() {
        let a = SignedDecimal::from_raw(u128::MAX, 0, Sign::Negative).unwrap();
        let b = SignedDecimal::from_raw(1, 38, Sign::Negative).unwrap();
    ...
    fn ord_both_overflow_reduce_both_fit_equal() {
        ...
        let a = SignedDecimal::from_raw(u128::MAX, 5, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(u128::MAX, 5, Sign::Positive).unwrap();
        assert_eq!(a.cmp(&b), std::cmp::Ordering::Equal);
    }
    ...
    fn ord_both_overflow_reduce_both_fit_gt() {
        ...
        let a = SignedDecimal::from_raw(u128::MAX, 1, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(u128::MAX - 1, 1, Sign::Positive).unwrap();
        assert!(a > b);
        assert!(b < a);
    }
    ...
    fn ord_both_overflow_reduce_both_fit_neg() {
        ...
        let a = SignedDecimal::from_raw(u128::MAX, 1, Sign::Negative).unwrap();
        let b = SignedDecimal::from_raw(u128::MAX - 1, 1, Sign::Negative).unwrap();
        assert!(a < b);
        assert!(b > a);
    }
    ...
    fn ord_both_overflow_reduce_one_still_overflow() {
        ...
        let a = SignedDecimal::from_raw(u128::MAX, 20, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(u128::MAX, 5, Sign::Positive).unwrap();
        assert!(a < b);
        assert!(b > a);
    }
    ...
    fn ord_both_overflow_reduce_still_overflow_neg() {
        ...
        let a = SignedDecimal::from_raw(u128::MAX, 20, Sign::Negative).unwrap();
        let b = SignedDecimal::from_raw(u128::MAX, 5, Sign::Negative).unwrap();
        assert!(a > b);
        assert!(b < a);
    }
    ...
    fn ord_trailing_zeros_normalized_before_compare() {
        ...
        let a = SignedDecimal::from_raw(10u128.pow(35), 5, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(10u128.pow(34), 0, Sign::Positive).unwrap();
        assert!(a < b);
        assert!(b > a);
    }
    ...
    fn ord_sort_integrity_extended() {
        let mut vals = vec![
            SignedDecimal::from_raw(u128::MAX, 0, Sign::Negative).unwrap(), // huge negative
            SignedDecimal::from_raw(10u128.pow(31), 5, Sign::Negative).unwrap(), // -10^26
            SignedDecimal::from_raw(1, 0, Sign::Negative).unwrap(),         // -1
            SignedDecimal::ZERO,
            SignedDecimal::from_raw(1, 38, Sign::Positive).unwrap(), // tiny positive
            SignedDecimal::from_raw(1, 0, Sign::Positive).unwrap(),  // 1
            SignedDecimal::from_raw(10u128.pow(31), 5, Sign::Positive).unwrap(), // 10^26
            SignedDecimal::from_raw(u128::MAX, 0, Sign::Positive).unwrap(), // huge positive
        ];
        vals.sort();
    ...
    fn add_zero_plus_zero() {
        let r = SignedDecimal::ZERO.add(SignedDecimal::ZERO).unwrap();
        assert_zero(r);
    }
    ...
    fn add_zero_plus_positive() {
        let a = SignedDecimal::from_str("5.5").unwrap();
        assert_eq!(SignedDecimal::ZERO.add(a).unwrap(), a);
    }
    ...
    fn add_positive_plus_zero() {
        let a = SignedDecimal::from_str("7").unwrap();
        assert_eq!(a.add(SignedDecimal::ZERO).unwrap(), a);
    }

    /// Invariant: a negative value plus zero returns itself.
    #[test]
    fn add_negative_plus_zero() {
        let a = SignedDecimal::from_str("-9").unwrap();
        assert_eq!(a.add(SignedDecimal::ZERO).unwrap(), a);
    }
    ...
    fn add_positive_same_scale() {
        let a = SignedDecimal::from_str("1.5").unwrap();
        let b = SignedDecimal::from_str("2.5").unwrap();
        assert_eq!(a.add(b).unwrap(), SignedDecimal::from_str("4.0").unwrap());
    }
    ...
    fn add_positive_diff_scale_integers_and_fractions() {
        assert_eq!(
            SignedDecimal::from_str("1.0")
                .unwrap()
                .add(SignedDecimal::from_str("0.5").unwrap())
                .unwrap(),
            SignedDecimal::from_str("1.5").unwrap()
        );
        assert_eq!(
            SignedDecimal::from_str("1.1")
                .unwrap()
                .add(SignedDecimal::from_str("1.09").unwrap())
                .unwrap(),
            SignedDecimal::from_str("2.19").unwrap()
        );
        assert_eq!(
            SignedDecimal::from_str("100")
                .unwrap()
                .add(SignedDecimal::from_str("0.001").unwrap())
                .unwrap(),
            SignedDecimal::from_str("100.001").unwrap()
        );
    }
    ...
    fn add_opposite_signs_same_scale() {
        assert_eq!(
            SignedDecimal::from_str("3.5")
                .unwrap()
                .add(SignedDecimal::from_str("-2.5").unwrap())
                .unwrap(),
            SignedDecimal::from_str("1.0").unwrap()
        );
        assert_eq!(
            SignedDecimal::from_str("2.5")
                .unwrap()
                .add(SignedDecimal::from_str("-3.5").unwrap())
                .unwrap(),
            SignedDecimal::from_str("-1.0").unwrap()
        );
        assert_eq!(
    ...
    fn add_opposite_signs_diff_scale() {
        assert_eq!(
            SignedDecimal::from_str("1.1")
                ...
                .add(SignedDecimal::from_str("-1.09").unwrap())
                .unwrap(),
            SignedDecimal::from_str("0.01").unwrap()
        );
        assert_eq!(
            SignedDecimal::from_str("-1.1")
                .unwrap()
    ...
    fn add_annihilates_to_zero() {
        assert_eq!(
            SignedDecimal::from_str("5")
                .unwrap()
                .add(SignedDecimal::from_str("-5").unwrap())
                .unwrap(),
            SignedDecimal::ZERO
        );
        assert_eq!(
            SignedDecimal::from_str("1.00")
                .unwrap()
                .add(SignedDecimal::from_str("-1.0").unwrap())
                .unwrap(),
            SignedDecimal::ZERO
        );
        // Very large match
        assert_eq!(
            SignedDecimal::from_str("1000000.123456789")
                .unwrap()
                .add(SignedDecimal::from_str("-1000000.123456789").unwrap())
                .unwrap(),
            SignedDecimal::ZERO
        );
    }
    ...
    fn add_catastrophic_cancellation() {
        let a = SignedDecimal::from_raw(1000000_123456789, 9, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(1000000_123456788, 9, Sign::Negative).unwrap();
    ...
    fn add_rescale_up_overflow() {
        let a = SignedDecimal::from_raw(u128::MAX, 0, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(1, 1, Sign::Positive).unwrap();
    ...
    fn add_rescale_up_overflow_max_scale() {
        let a = SignedDecimal::from_raw(u128::MAX, 0, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(1, SignedDecimal::MAX_SCALE, Sign::Positive).unwrap();
        assert_eq!(a.add(b), Err(DecimalError::Overflow));
    }
    ...
    fn add_rescale_up_overflow_reverse_args() {
        let a = SignedDecimal::from_raw(1, SignedDecimal::MAX_SCALE, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(u128::MAX, 0, Sign::Positive).unwrap();
        assert_eq!(a.add(b), Err(DecimalError::Overflow));
    }
    ...
    fn add_sum_overflow() {
        let a = SignedDecimal::from_raw(u128::MAX, 0, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(1, 0, Sign::Positive).unwrap();
        assert_eq!(a.add(b), Err(DecimalError::Overflow));
    }
    ...
    fn add_sum_at_u128_max() {
        let a = SignedDecimal::from_raw(u128::MAX - 1, 0, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(1, 0, Sign::Positive).unwrap();
        let r = a.add(b).unwrap();
    ...
    fn add_sum_at_u128_max_negative() {
        let a = SignedDecimal::from_raw(u128::MAX - 1, 0, Sign::Negative).unwrap();
        let b = SignedDecimal::from_raw(1, 0, Sign::Negative).unwrap();
        let r = a.add(b).unwrap();
    ...
    fn add_commutative() {
        let a = SignedDecimal::from_str("123.45").unwrap();
        let b = SignedDecimal::from_str("-67.89").unwrap();
    ...
    fn add_zero_identity() {
        for s in ["0", "1", "-1", "999.999", "-0.001"] {
            let v = SignedDecimal::from_str(s).unwrap();
            assert_eq!(v.add(SignedDecimal::ZERO).unwrap(), v);
            assert_eq!(SignedDecimal::ZERO.add(v).unwrap(), v);
        }
    }
    ...
    fn add_inverse() {
        for s in ["42", "0.001", "9999999", "-17.5"] {
            ...
            let neg = match v.sign() {
                Sign::Positive => {
                    SignedDecimal::from_raw(v.as_raw(), v.scale(), Sign::Negative).unwrap()
                }
                Sign::Negative => {
                    SignedDecimal::from_raw(v.as_raw(), v.scale(), Sign::Positive).unwrap()
                }
                Sign::Zero => SignedDecimal::ZERO,
            };
            assert_eq!(
                v.add(neg).unwrap(),
                SignedDecimal::ZERO,
    ...
    fn add_both_max_scale_positive() {
        let a = SignedDecimal::from_raw(3, SignedDecimal::MAX_SCALE, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(2, SignedDecimal::MAX_SCALE, Sign::Positive).unwrap();
        let r = a.add(b).unwrap();
        assert_positive(
            r,
            5,
            SignedDecimal::MAX_SCALE,
            &format!("0.{}5", "0".repeat(SignedDecimal::MAX_SCALE as usize - 1)),
        );
    }
    ...
    fn add_both_max_scale_negative() {
        let a = SignedDecimal::from_raw(3, SignedDecimal::MAX_SCALE, Sign::Negative).unwrap();
        let b = SignedDecimal::from_raw(2, SignedDecimal::MAX_SCALE, Sign::Negative).unwrap();
        let r = a.add(b).unwrap();
        assert_negative(
            r,
            5,
    ...
    fn add_opposite_signs_max_scale() {
        let a = SignedDecimal::from_raw(5, SignedDecimal::MAX_SCALE, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(2, SignedDecimal::MAX_SCALE, Sign::Negative).unwrap();
        let r = a.add(b).unwrap();
        assert_positive(
            r,
            3,
            SignedDecimal::MAX_SCALE,
            &format!("0.{}3", "0".repeat(SignedDecimal::MAX_SCALE as usize - 1)),
        );
    }
    ...
    fn sub_zero_minus_zero() {
        assert_zero(SignedDecimal::ZERO.sub(SignedDecimal::ZERO).unwrap());
    }

    /// Invariant: zero minus a positive yields the negative of that value.
    #[test]
    fn sub_zero_minus_positive() {
        let b = SignedDecimal::from_str("5.5").unwrap();
        let r = SignedDecimal::ZERO.sub(b).unwrap();
    ...
    fn sub_x_minus_zero() {
        assert_eq!(
            SignedDecimal::from_str("7")
                .unwrap()
                .sub(SignedDecimal::ZERO)
                .unwrap(),
            SignedDecimal::from_str("7").unwrap()
        );
        assert_eq!(
            SignedDecimal::from_str("-9")
                .unwrap()
                .sub(SignedDecimal::ZERO)
                .unwrap(),
            SignedDecimal::from_str("-9").unwrap()
        );
    }
    ...
    fn sub_self_minus_self() {
        assert_zero(
            SignedDecimal::from_str("42.5")
                .unwrap()
                .sub(SignedDecimal::from_str("42.5").unwrap())
                .unwrap(),
        );
        assert_zero(
            SignedDecimal::from_str("-42.5")
    ...
    fn sub_positive_larger_minus_smaller() {
        assert_eq!(
            SignedDecimal::from_str("3")
                .unwrap()
                .sub(SignedDecimal::from_str("1").unwrap())
                .unwrap(),
    ...
    fn sub_positive_smaller_minus_larger() {
        assert_eq!(
            SignedDecimal::from_str("1")
                .unwrap()
                .sub(SignedDecimal::from_str("3").unwrap())
                .unwrap(),
            SignedDecimal::from_str("-2").unwrap()
        );
    }
    ...
    fn sub_diff_scales() {
        assert_eq!(
            SignedDecimal::from_str("1.1")
                .unwrap()
                .sub(SignedDecimal::from_str("1.09").unwrap())
                .unwrap(),
            SignedDecimal::from_str("0.01").unwrap()
        );
        assert_eq!(
            SignedDecimal::from_str("1.09")
                .unwrap()
                .sub(SignedDecimal::from_str("1.1").unwrap())
                .unwrap(),
            SignedDecimal::from_str("-0.01").unwrap()
        );
    }
    ...
    fn sub_rescale_overflow() {
        let a = SignedDecimal::from_raw(u128::MAX, 0, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(1, SignedDecimal::MAX_SCALE, Sign::Negative).unwrap();
    ...
    fn sub_antisymmetric() {
        let a = SignedDecimal::from_str("7.3").unwrap();
        let b = SignedDecimal::from_str("2.1").unwrap();
    ...
    fn sub_add_roundtrip() {
        let a = SignedDecimal::from_str("100.5").unwrap();
        let b = SignedDecimal::from_str("23.25").unwrap();
    ...
    #[test]
    fn mul_zero() {
        let x = SignedDecimal::from_str("5").unwrap();
        assert_zero(SignedDecimal::ZERO.mul(x).unwrap());
        assert_zero(x.mul(SignedDecimal::ZERO).unwrap());
        assert_zero(SignedDecimal::ZERO.mul(SignedDecimal::ZERO).unwrap());
        let neg = SignedDecimal::from_str("-5").unwrap();
        assert_zero(SignedDecimal::ZERO.mul(neg).unwrap());
    }

    /// Invariant: multiplying by one preserves the value.
    #[test]
    fn mul_identity() {
        let one = SignedDecimal::from_str("1").unwrap();
        assert_eq!(
            SignedDecimal::from_str("42.5").unwrap().mul(one).unwrap(),
            SignedDecimal::from_str("42.5").unwrap()
        );
        assert_eq!(
            one.mul(SignedDecimal::from_str("42.5").unwrap()).unwrap(),
            SignedDecimal::from_str("42.5").unwrap()
        );
    ...
    #[test]
    fn mul_by_neg_one() {
        let neg_one = SignedDecimal::from_str("-1").unwrap();
        assert_eq!(
            SignedDecimal::from_str("42.5")
                .unwrap()
                .mul(neg_one)
    ...
    fn mul_integers() {
        assert_eq!(
            SignedDecimal::from_str("2")
                .unwrap()
                .mul(SignedDecimal::from_str("3").unwrap())
                .unwrap(),
            SignedDecimal::from_str("6").unwrap()
        );
    }
    ...
    fn mul_fractions() {
        assert_eq!(
            SignedDecimal::from_str("0.5")
                .unwrap()
                .mul(SignedDecimal::from_str("0.5").unwrap())
                .unwrap(),
            SignedDecimal::from_str("0.25").unwrap()
        );
        assert_eq!(
            SignedDecimal::from_str("-0.5")
                .unwrap()
    ...
    fn mul_scale_accumulation_fits() {
        assert_eq!(
            SignedDecimal::from_str("0.1")
                .unwrap()
                .mul(SignedDecimal::from_str("0.1").unwrap())
                .unwrap(),
            SignedDecimal::from_str("0.01").unwrap()
        );
        // 0.0001 * 0.0001 = 0.00000001 (inner=1, scale=8)
        let r = SignedDecimal::from_str("0.0001")
            .unwrap()
            .mul(SignedDecimal::from_str("0.0001").unwrap())
            .unwrap();
    ...
    fn mul_scale_overflow_saved_by_trailing_zeros() {
        ...
        assert_eq!(
            SignedDecimal::from_str("1.00")
                .unwrap()
                .mul(SignedDecimal::from_str("1.00").unwrap())
                .unwrap(),
            SignedDecimal::from_str("1").unwrap()
        );
    }
    ...
    fn mul_scale_overflow_truncation_nonzero() {
        ...
        // drop 2 → 3/10^38
        let a = SignedDecimal::from_raw(31, 10, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(11, 30, Sign::Positive).unwrap();
    ...
    fn mul_scale_overflow_truncation_to_zero() {
        ...
        let a = SignedDecimal::from_raw(13, 20, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(7, 20, Sign::Positive).unwrap();
    ...
    fn mul_inner_overflow() {
        let a = SignedDecimal::from_raw(u128::MAX, 0, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(2, 0, Sign::Positive).unwrap();
    ...
    fn mul_inner_borderline() {
        let a = SignedDecimal::from_raw(u128::MAX / 2, 0, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(2, 0, Sign::Positive).unwrap();
        let r = a.mul(b).unwrap();
    ...
    #[test]
    fn mul_scale_at_max() {
        let a = SignedDecimal::from_raw(2, 19, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(3, 19, Sign::Positive).unwrap();
        let r = a.mul(b).unwrap();
        assert_positive(
            r,
            6,
            SignedDecimal::MAX_SCALE,
            &format!("0.{}6", "0".repeat(SignedDecimal::MAX_SCALE as usize - 1)),
        );
    }
    ...
    fn mul_negative_scale_overflow_truncation() {
        let a = SignedDecimal::from_raw(31, 10, Sign::Negative).unwrap();
        let b = SignedDecimal::from_raw(11, 30, Sign::Positive).unwrap();
        let r = a.mul(b).unwrap();
        assert_negative(
            r,
    ...
    fn mul_negative_negative_scale_overflow_truncation_to_zero() {
        let a = SignedDecimal::from_raw(13, 20, Sign::Negative).unwrap();
        let b = SignedDecimal::from_raw(7, 20, Sign::Negative).unwrap();
        assert_zero(a.mul(b).unwrap());
    }
    ...
    fn mul_scale_exact() {
        ...
        let a = SignedDecimal::from_raw(2, 3, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(3, 2, Sign::Positive).unwrap();
        let r = a.mul(b).unwrap();
    ...
    fn mul_strip_trailing_zeros_saves_from_truncation() {
        ...
        let a = SignedDecimal::from_raw(10u128.pow(19), 36, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(10u128.pow(19), 36, Sign::Positive).unwrap();
        let r = a.mul(b).unwrap();
    ...
    fn div_by_zero() {
        ...
        assert_eq!(
            SignedDecimal::ZERO.div(SignedDecimal::ZERO),
            Err(DecimalError::DivisionByZero)
        );
    }
    ...
    fn div_zero_dividend() {
        assert_zero(
            SignedDecimal::ZERO
                .div(SignedDecimal::from_str("5").unwrap())
                .unwrap(),
        );
        assert_zero(
            SignedDecimal::ZERO
    ...
    fn div_exact_integers() {
        assert_eq!(
            SignedDecimal::from_str("6")
                .unwrap()
                .div(SignedDecimal::from_str("3").unwrap())
                .unwrap(),
            SignedDecimal::from_str("2").unwrap()
        );
        assert_eq!(
            SignedDecimal::from_str("10")
                .unwrap()
                .div(SignedDecimal::from_str("4").unwrap())
                .unwrap(),
            SignedDecimal::from_str("2.5").unwrap()
        );
    }
    ...
    fn div_exact_fractions() {
        assert_eq!(
            SignedDecimal::from_str("1")
                .unwrap()
                .div(SignedDecimal::from_str("2").unwrap())
                .unwrap(),
        ...
        let r = SignedDecimal::from_str("1")
            .unwrap()
            .div(SignedDecimal::from_str("8").unwrap())
            .unwrap();
    ...
    fn div_non_terminating_one_third() {
        let r = SignedDecimal::from_str("1")
            ...
            .div(SignedDecimal::from_str("3").unwrap())
            .unwrap();
        assert_eq!(r.scale(), SignedDecimal::MAX_SCALE);
        assert_eq!(r.sign(), Sign::Positive);
        let expected: u128 = (0..SignedDecimal::MAX_SCALE).fold(0u128, |acc, _| acc * 10 + 3);
    ...
    fn div_non_terminating_one_seventh() {
        let r = SignedDecimal::from_str("1")
            .unwrap()
            .div(SignedDecimal::from_str("7").unwrap())
            .unwrap();
        assert_eq!(r.scale(), SignedDecimal::MAX_SCALE);
        assert_eq!(r.sign(), Sign::Positive);
    }
    ...
    fn div_by_one() {
        let one = SignedDecimal::from_str("1").unwrap();
        assert_eq!(
            SignedDecimal::from_str("42.5").unwrap().div(one).unwrap(),
            SignedDecimal::from_str("42.5").unwrap()
        );
        assert_eq!(
            SignedDecimal::from_str("-42.5").unwrap().div(one).unwrap(),
    ...
    fn div_scale_divisor_larger() {
        assert_eq!(
            SignedDecimal::from_str("0.2")
                .unwrap()
                .div(SignedDecimal::from_str("0.01").unwrap())
                .unwrap(),
            SignedDecimal::from_str("20").unwrap()
        );
        assert_eq!(
            SignedDecimal::from_str("2")
                .unwrap()
                .div(SignedDecimal::from_str("0.001").unwrap())
                .unwrap(),
            SignedDecimal::from_str("2000").unwrap()
        );
    }
    ...
    fn div_scale_dividend_larger() {
        assert_eq!(
            SignedDecimal::from_str("0.01")
                .unwrap()
                .div(SignedDecimal::from_str("0.2").unwrap())
                .unwrap(),
            SignedDecimal::from_str("0.05").unwrap()
        );
        assert_eq!(
            SignedDecimal::from_str("0.001")
                .unwrap()
                .div(SignedDecimal::from_str("1").unwrap())
                .unwrap(),
        ...
        assert_eq!(
            SignedDecimal::from_str("0.01")
                ...
                .div(SignedDecimal::from_str("2").unwrap())
                .unwrap(),
            SignedDecimal::from_str("0.005").unwrap()
        );
    }
    ...
    fn div_tiny_result_is_zero() {
        let a = SignedDecimal::from_raw(1, 0, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(u128::MAX, 0, Sign::Positive).unwrap();
    ...
    fn div_large_result() {
        let a = SignedDecimal::from_raw(u128::MAX, 0, Sign::Positive).unwrap();
        let r = a.div(SignedDecimal::from_str("1").unwrap()).unwrap();
        assert_positive(r, u128::MAX, 0, &u128::MAX.to_string());
    }
    ...
    fn div_overflow_fractional_digits() {
        ...
        let a = SignedDecimal::from_raw(10u128.pow(35), 0, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(3, 0, Sign::Positive).unwrap();
        let r = a.div(b);
        match r {
            Ok(val) => {
    ...
    fn div_all_zero_fractional_digits() {
        let r = SignedDecimal::from_str("1")
            .unwrap()
            .div(SignedDecimal::from_str("1000000").unwrap())
            .unwrap();
    ...
    fn property_distributive() {
        let a = SignedDecimal::from_str("3").unwrap();
        let b = SignedDecimal::from_str("4").unwrap();
        let c = SignedDecimal::from_str("5").unwrap();
    ...
    fn property_div_mul_roundtrip() {
        let a = SignedDecimal::from_str("100").unwrap();
        let b = SignedDecimal::from_str("25").unwrap();
    ...
    fn div_both_max_scale() {
        // 6/10^38 ÷ 2/10^38 = 3
        let a = SignedDecimal::from_raw(6, SignedDecimal::MAX_SCALE, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(2, SignedDecimal::MAX_SCALE, Sign::Positive).unwrap();
        let r = a.div(b).unwrap();
        assert_positive(r, 3, 0, "3");
    }
    ...
    fn div_both_max_scale_non_terminating() {
        let a = SignedDecimal::from_raw(1, SignedDecimal::MAX_SCALE, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(3, SignedDecimal::MAX_SCALE, Sign::Positive).unwrap();
        let r = a.div(b).unwrap();
        assert_eq!(r.scale(), SignedDecimal::MAX_SCALE);
        assert_eq!(r.sign(), Sign::Positive);
        let expected: u128 = (0..SignedDecimal::MAX_SCALE).fold(0u128, |acc, _| acc * 10 + 3);
    ...
    fn div_scale_truncation_partial() {
        ...
        let a = SignedDecimal::from_raw(1, 10, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(3, 0, Sign::Positive).unwrap();
        let r = a.div(b).unwrap();
        assert_eq!(r.scale(), SignedDecimal::MAX_SCALE);
        assert_eq!(r.sign(), Sign::Positive);
        ...
        let expected: u128 =
            (0..(SignedDecimal::MAX_SCALE - 10)).fold(0u128, |acc, _| acc * 10 + 3);
        assert_eq!(r.as_raw(), expected);
    }
    ...
    fn div_scale_truncation_to_zero() {
        ...
        let a = SignedDecimal::from_raw(1, 38, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(7, 0, Sign::Positive).unwrap();
        assert_zero(a.div(b).unwrap());
    }
    ...
    fn div_by_one_exact_representation() {
        let a = SignedDecimal::from_raw(425, 1, Sign::Positive).unwrap(); // 42.5
        let r = a.div(SignedDecimal::from_str("1").unwrap()).unwrap();
    ...
    fn div_by_neg_one_exact_representation() {
        let a = SignedDecimal::from_raw(425, 1, Sign::Positive).unwrap();
        let r = a.div(SignedDecimal::from_str("-1").unwrap()).unwrap();
    ...
    fn div_scale_dividend_larger_exact_repr() {
        ...
        let r = SignedDecimal::from_str("0.01")
            .unwrap()
            .div(SignedDecimal::from_str("0.2").unwrap())
            .unwrap();
    ...
    fn div_exact_integer_exact_repr() {
        let r = SignedDecimal::from_str("15")
            .unwrap()
            .div(SignedDecimal::from_str("5").unwrap())
            .unwrap();
        assert_positive(r, 3, 0, "3");
    ...
    fn div_fractional_digit_accumulation_overflow() {
        ...
        let a = SignedDecimal::from_raw(u128::MAX / 2, 0, Sign::Positive).unwrap();
        let b = SignedDecimal::from_raw(10u128.pow(35), 0, Sign::Positive).unwrap();
        let r = a.div(b);
        match r {
            Ok(val) => {
    ...
    fn div_periodic_multi_digit_divisor() {
        let r = SignedDecimal::from_str("1")
            .unwrap()
            .div(SignedDecimal::from_str("700").unwrap())
            .unwrap();
        assert_positive(
            r,
